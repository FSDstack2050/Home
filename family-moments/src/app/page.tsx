      ...
      <div className="w-full max-w-sm text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500 text-sm max-w-xs mx-auto">
            Share daily check-ins, emotions, and moments with your family — no matter where you are.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          ...
          <div className="bg-white/60 backdrop-blur rounded-2xl p-4">
            <div className="text-2xl mb-1">🐕</div>
            <div className="text-xs font-bold text-gray-700">Pet Profiles</div>
            <div className="text-[10px] text-gray-400">Furry family too</div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <Link
            href="/register"
            className="block w-full py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold rounded-2xl text-lg shadow-lg hover:opacity-90 transition-opacity"
          >
            Create Your Family
          </Link>
          <Link
            href="/join"
            className="block w-full py-4 bg-white/80 text-purple-600 font-bold rounded-2xl text-lg border-2 border-purple-200 hover:border-purple-300 transition-colors"
          >
            Join a Family
          </Link>
          <Link
